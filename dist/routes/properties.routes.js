...
router.post('/add-type', User_controller_1.token, Properties_controller_1.propertiesController.saveType);
...
router.post('/add-group', User_controller_1.token, Properties_controller_1.propertiesController.saveGroup);
...
router.post('/add-marca', User_controller_1.token, Properties_controller_1.propertiesController.saveMarca);
...
router.post('/add-state', User_controller_1.token, Properties_controller_1.propertiesController.saveState);
...
router.post('/add-size', User_controller_1.token, Properties_controller_1.propertiesController.saveSize);
...
router.post('/add-color', User_controller_1.token, Properties_controller_1.propertiesController.saveColor);
